...
<%
    ...
    ArrayList<Bodega> Lbd = bq.buscar(valor);
	...
	<form action="../Productos" method="post">
		<table border="1">
                    ...
                    %>
                        <tr>
                                <td>Id Producto</td>
                                <td><input type="number" readonly="readonly" value="<%=tmp.getID_BO()%>" name="idbole"></td>
                        </tr>
			<tr>
				<td>Nombre:</td>
				<td><input type="text" name="nombree" value="<%=tmp.getNOMBRE_PRODUCTO()%>" size="50"></td>
			</tr>

			<tr>
				<td>Unidad de Medida: </td>
				<td><input type="text" name="unidadMe" value="<%=tmp.getUNIDAD_MEDIDA()%>" size="50"></td>
			</tr>
			<tr>
				<td>Stock:</td>
                                <td><input type="number" name="stocke" value="<%=tmp.getSTOCK_PROD()%>"></td>
			</tr>
                     <%
                         }
                     %>
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Modificar">
