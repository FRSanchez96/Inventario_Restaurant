...
%> <!--sidebar end--> <!-- **********************************************************************************************************************************************************
	...
	<h3>Modificación del Menú</h3>
	<h4>Bienvenido en esta seccion puede modificar el menú seleccionado</h4>
<%
...
%>
	<form action="../Cocina" method="post">
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Modificar Menu">
