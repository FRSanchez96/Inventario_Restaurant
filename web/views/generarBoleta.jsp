...
%> <!--sidebar end--> <!-- **********************************************************************************************************************************************************
	...
	<h3>Ingresar Boleta</h3>
	<h4>Bienvenido en esta seccion puede agregar sus boletas</h4>
<%
    BoletaDAO list = new BoletaDAO();
    PedidosDAO lt = new PedidosDAO();
    Tipo_PagoDAO qa = new Tipo_PagoDAO();
    ArrayList<Tipo_Pago> qq = qa.ListTip_Pago();
    ArrayList<Boleta> tp = list.ListBoletas();
    ArrayList<Pedidos> hp = lt.ListPedidos();
%>
	<form action="../Boleta" method="post">
		<table border="1">
			<tr>
				<td>Tipo de Pago:</td>
                                <td><select name="cbxTPago">
                                    <%
                                        for(Tipo_Pago tmp:qq)
                                        {
                                    %>
                                    <option value="<%=tmp.getDescripcion()%>"><%=tmp.getDescripcion()%></option>
                                    <%        
                                        }
                                    %> 
                                    </select>
			...
			<tr>
				...
				<td><input type="text" name="detP" size="50"></td>
			</tr>
			<tr>
				<td>Numero pedido: </td>
                                <td><input type="number" name="numP" ></td>
			</tr>
                        <tr>
				<td>Numero de Transacción: </td>
                                <td><input type="number" name="numT" ></td>
			</tr>
                        <tr>
				<td>Total boleta: </td>
                                <td><input type="number" name="totalB" ></td>
			</tr>
                        
		</table>

        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Guardar Boleta">
        
        
        <a href="../views/finanzas.jsp" class="btn btn-primary" role="button"> Volver al menú</a>
