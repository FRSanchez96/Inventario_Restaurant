...
<%
 ...
 %>
	...
	<h4>Bienvenido en esta seccion puede agregar usuarios</h4>
	<form action="../Admin" method="post">
		<table border="1">
                        <tr>
                                <td>Rut:</td>
                                <td><input type="text"  value="" name="rutU"></td>
                        </tr>
			<tr>
				<td>Nombre:</td>
				...
				<td>Apellido Paterno:</td>
                                <td><input type="text" name="ap" value=""></td>
			</tr>
                        <tr>
				<td>Apeliido Materno:</td>
                                <td><input type="text" name="am" value=""></td>
			</tr>
                         <tr>
				<td>Sexo:</td>
                        ...
                        <tr>
				<td>Dirección:</td>
				<td><input type="text" name="direU"  value="" size="50"></td>
			</tr>
                        <tr>
				<td>Telefono Celular:</td>
                                <td><input type="text" name="teleC" value=""></td>
			</tr>
                        <tr>
				<td>Telefono Fijo:</td>
                                <td><input type="text" name="teleF" value=""></td>
			</tr>
                        <tr>
				<td>Email:</td>
                                <td><input type="text" name="mailU" value=""></td>
			</tr>
                        <tr>
				<td>Contraseña:</td>
                                <td><input type="text" name="contraU" value=""></td>
			</tr>
                        <tr>
				<td>Estado:</td>
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Agregar Usuario">
