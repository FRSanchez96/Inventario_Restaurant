...
%> <!--sidebar end--> <!-- **********************************************************************************************************************************************************
	...
	<h4>Bienvenido en esta seccion puede ingresar una factura</h4>
<%
...
%>
	<form action="../Factura" method="post">
		<table border="1">
                        ...
                        <tr>
				<td>Monto factura:</td>
                                <td><input type="number"  name="montoF" ></td>
			</tr>
                        <tr>
				<td>Descripción:</td>
				<td><input type="text"  name="DescripcionF" value="" size="50"></td>
			</tr>
                        <tr>
				<td>Total a pagar:</td>
				<td><input type="number"  name="totalPagoF" value="" ></td>
			</tr>
                    
                        <tr>
				<td>Nombre Proveedor:</td>
                               
                                <td><select name="rProv">
                                <%
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Ingresar Factura">
