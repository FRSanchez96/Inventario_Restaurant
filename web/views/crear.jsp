...
%><!--sidebar end--> <!-- **********************************************************************************************************************************************************
	...
	<h3>Ingresar producto a bodega</h3>
	<h4>Bienvenido en esta seccion puede agregar sus productos</h4>
<%
    BodegaDAO list = new BodegaDAO();
    ArrayList<Tipo_Producto> tp = list.ListTipoProdu();
	...
	<form action="../Productos" method="post">
		<table border="1">
			...
			<tr>
				...
				<td><input type="text" name="unidadM" size="50"></td>
			</tr>
			<tr>
				<td>Stock:</td>
                        ...
                        <tr>
				<td>Tipo Producto</td>
                                <td><select name="cbxTipo">
                                    <%
                                        for(Tipo_Producto tmp:tp)
                                        {
                                    %>
                                    <option value="<%=tmp.getId_producto()%>"><%=tmp.getDescripcion()%></option>
                                    <%        
                                        }
                                    %> 
                                    </select>
				...
				<td>Historial Producto:</td>
                                <td><select name="cbxHistorial">
                                    <%
                                        for(Historial_Producto tmi:hp)
                                        {
                                    %>
                                    <option value="<%=tmi.getId_h_prod()%>"><%=tmi.getFecha_ingreso()%></option>
                                    <%
                                        }
                                    %>
                                    </select>
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Guardar">
