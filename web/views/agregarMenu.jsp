...
%> <!--sidebar end--> <!-- **********************************************************************************************************************************************************
	...
	<h3>Agregar Menu</h3>
	<h4>Bienvenido en esta seccion puede agregar un menu</h4>
<%
    
        CocinaDAO aa = new CocinaDAO();
        PedidosDAO qq = new PedidosDAO();
        ArrayList<Cocina> tp = aa.ListCocina();
        ArrayList<Pedidos> tq = qq.ListPedidos();
%>
	<form action="../Cocina" method="post">
		<table border="1">
				...
				<td>Nombre del Menu:</td>
                                <td><input type="text"  name="nombreM" ></td>
			</tr>
                        <tr>
				<td>Precio:</td>
                                <td><input type="number"  name="precioM" ></td>
			</tr>
                        <tr>
				<td>Descripcion:</td>
                                <td><input type="text"  name="descripcionM" ></td>
			</tr>
                        <tr>
				<td>Preparación:</td>
                        ...
                        <tr>
				<td>Agregado/s:</td>
                                <td><input type="text"  name="agreM" ></td>
			</tr>
                        <tr>
				<td>Tiempo de Cocina:</td>
                               
                                <td><select name="tiemM">
                                <%
                                     for(Cocina tmx:tp)
                                        {
                                %>
                                        <option value="<%=tmx.getId_cocina()%>"><%=tmx.getTiempo()%></option>
                                <%
                                        }
                                %>
                                </select>
				...
				<td>Pedido:</td>
                                ...
                                <td><select name="pedidoM">
                                <%
                                     for(Pedidos tmx:tq)
                                        {
                                %>
                                        <option value="<%=tmx.getID_PEDIDO()%>"><%=tmx.getESTADO_PEDIDO()%></option>
                                <%
                                        }
                                %>
                                </select>
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Agregar Menu">
