...
<%
 ...
 %>
	...
	<h3>Modificación de factura</h3>
	<h4>Bienvenido en esta seccion puede modificar sus facturas</h4>
<%
    int valor = Integer.parseInt(request.getParameter("Id_BO"));
    
    FacturaDAO bq = new FacturaDAO();
    BodegaDAO qq =  new BodegaDAO();
    ArrayList<Factura> Lbd = bq.buscarFactura(valor);
    ArrayList<Proveedor> lpq = qq.LProve();
...
%>
	<form action="../Admin" method="post">
		<table border="1">
                    ...
                    %>
                        <tr>
                                ...
                                <td><input type="number" readonly="readonly" value="<%=tmp.getId_factura()%>" name="idF"></td>
                        </tr>
			<tr>
				<td>Monto de la Factura:</td>
				<td><input type="number" name="monF" value="<%=tmp.getMonto_factura()%>" size="50"></td>
			</tr>
                        <tr>
				<td>Descripción de la factura:</td>
                                <td><input type="text" name="desF" value="<%=tmp.getDescripcion_factura()%>"></td>
			</tr>
                        <tr>
				<td>Total Factura:</td>
                                <td><input type="text" name="totalF" value="<%=tmp.getTotal_factura()%>"></td>
			</tr>
                        <tr>
				<td>Nombre del Proveedor:</td>
                                <td><select name="nomP">
                                    <%
                                        for(Proveedor tmx:lpq)
                                        {
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Modificar Factura">
