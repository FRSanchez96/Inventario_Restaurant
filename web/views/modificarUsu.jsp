...
<%
 ...
 %>
	...
	<h4>Bienvenido en esta seccion puede modificar sus usuarios</h4>
<%
    String valor = request.getParameter("Id_BO");
	...
	<form action="../Admin" method="post">
		<table border="1">
                    <%
                        for(Usuario tmp:ww)
                        {
                            if(tmp.getRUT().equalsIgnoreCase(valor)){
                    %>
                        <tr>
                                <td>Rut:</td>
                                <td><input type="text" readonly="readonly" value="<%=tmp.getRUT()%>" name="rutU"></td>
                        </tr>
			<tr>
				<td>Nombre:</td>
				<td><input type="text" name="nom" value="<%=tmp.getNOMBRE()%>" size="50"></td>
			</tr>
                        <tr>
				<td>Apellido Paterno:</td>
                                <td><input type="text" name="ap" value="<%=tmp.getAPELLIDO_PATERNO()%>"></td>
			</tr>
                        <tr>
				<td>Apeliido Materno:</td>
                                <td><input type="text" name="am" value="<%=tmp.getAPELLIDO_MATERNO()%>"></td>
			</tr>
                     <%
                         if(tmp.getSEXO()=='F' || tmp.getSEXO()=='f'){
                     %>
                        <tr>
				<td>Sexo:</td>
                               
                                <td><select name="estadoM">
                                        <option value="<%=tmp.getSEXO()%>">Femenino</option>
				...
				<td>Sexo:</td>
                    ...
                    %>
                        <tr>
				<td>Dirección:</td>
				<td><input type="text" name="direU" readonly="readonly" value="<%=tmp.getDIRECCION()%>" size="50"></td>
			</tr>
                        <tr>
				<td>Telefono Celular:</td>
                                <td><input type="text" name="teleC" value="<%=tmp.getTELEFONO_CELULAR()%>"></td>
			</tr>
                        <tr>
				<td>Telefono Fijo:</td>
                                <td><input type="text" name="teleF" value="<%=tmp.getTELEFONO_FIJO()%>"></td>
			</tr>
                        <tr>
				<td>Email:</td>
                                <td><input type="text" name="mailU" value="<%=tmp.getEMAIL()%>"></td>
			</tr>
                        <tr>
				<td>Contraseña:</td>
                                <td><input type="text" name="contraU" value="<%=tmp.getCONTRASENIA()%>"></td>
			</tr>
                        <tr>
				<td>Estado:</td>
                               
                                <td><select name="estadoU">
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Modificar Usuario">
