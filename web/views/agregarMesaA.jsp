...
<%
 ...
 %>
	...
	<h3>Ingresar Mesa</h3>
	<h4>Bienvenido en esta seccion puede ingresar una nueva Mesa</h4>
<%
...
%>
	<form action="../Admin" method="post">
		<table border="1">
			<tr>
				...
				<td>Cantidad de Sillas:</td>
                                <td><input type="number" name="cantidadS" value=""></td>
			</tr>
                         <tr>
				<td>EMP:</td>
                                ...
                                <%
                                     for(Empleado tmx:bb)
                                        {
                                %>
                                        <option value="<%=tmx.getID_EMP()%>"><%=tmx.getESCRIPCION()%></option>
                                <%
                                        }
                                %>
                                </select>
				...
				<td>RESERVA:</td>
                                ...
                                <%
                                     for(Reserva tmx:cc)
                                        {
                                %>
                                        <option value="<%=tmx.getID_RESERVA()%>"><%=tmx.getFECHA_RESERVA()%></option>
                                <%
                                        }
                                %>
                                </select>
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Ingresar Mesa">
