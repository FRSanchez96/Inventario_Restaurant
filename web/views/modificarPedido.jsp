...
%> <!--sidebar end--> <!-- **********************************************************************************************************************************************************
	...
	<h3>Modificación de producto en bodega</h3>
	<h4>Bienvenido en esta seccion puede modificar sus productos</h4>
<%
    int valor = Integer.parseInt(request.getParameter("Id_BO"));
    
    CocinaDAO qq = new CocinaDAO();
    PedidosDAO aa = new PedidosDAO();
    ArrayList<Carta> ll = qq.buscarMenu(valor);
    ArrayList<Cocina> pp = qq.ListCocina();
    ArrayList<Pedidos> oo = aa.ListPedidos();
...
%>
	<form action="../Cocina" method="post">
		<table border="1">
                    ...
                    %>
                        <tr>
                                <td>Numero del Menu:</td>
                                <td><input type="number" readonly="readonly" value="<%=tmp.getID_MENU()%>" name="idC"></td>
                        </tr>
			<tr>
				<td>Nombre del Menu:</td>
				<td><input type="text" name="nomC" readonly="readonly" value="<%=tmp.getNOMBRE_MENU()%>" size="50"></td>
			</tr>
                        <tr>
				<td>Precio:</td>
                                <td><input type="number" name="preC" value="<%=tmp.getPRECIO()%>"></td>
			</tr>
                        <tr>
				<td>Descripción:</td>
                                <td><input type="text" name="desC" value="<%=tmp.getDESCRIPCION()%>"></td>
			</tr>
                        <tr>
				<td>Agregado:</td>
                                <td><input type="text" name="agreC" value="<%=tmp.getAGREGADO()%>"></td>
			</tr>
                     <%
                         }
                     %>
        ...
        <br> 
        <input type="submit" class="btn btn-primary" name="opcion" value="Modificar Carta">
