...
<%
 ...
 %>
    ...
    int n = fecha.getActualMinimum(Calendar.DAY_OF_MONTH);
    String dia = String.valueOf(n);
    ...
    int wnm = fecha.getActualMaximum(Calendar.DAY_OF_MONTH);
    
    String dia2 = String.valueOf(wnm);
    
    String fett = dia2+"/"+mes+"/"+año;
    
    ArrayList <Boleta> tpqq = lq.calcularDiaBole3(fet,fett);
