			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a href="javascript:;"
						...
						<ul class="sub">
							<li><a href="calendario.jsp">Gestionar calendario eventos</a></li>
						</ul>
					</li>
					...
					<li class="sub-menu"><a href="javascript:;"
						...
						<ul class="sub">
							<li><a href="bodega.jsp">Gestionar Bodega</a></li>
						</ul>
					</li>
					<li class="sub-menu"><a href="javascript:;"
						class="dcjq-parent active"> <i class="fa fa-tasks"></i> <span>Gestion
					...
					<aside class="col-lg-3 mt">
						...
						<div id="external-events">
							...
							<div class="external-event label label-warning">Reservado
								empresa</div>
							<div class="external-event label label-danger">Cumpleaños</div>
							...
							<p class="drop-after">
								<input type="checkbox" id="drop-remove"> Remover despuès
								de soltar
							</p>
						</div>
					</aside>
