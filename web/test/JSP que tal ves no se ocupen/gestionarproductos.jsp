...
<body>
	...
	<!--logo start--> <a href="administracion.html" class="logo"><b>
	...
	<div id="sidebar" class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<p class="centered">
				<a href="administracion.html"><img
	...
	<h4>Bienvenido al panel de gestion de productos</h4>

	<table border="1">
		<div class="container">
			<h3>Elija una opcion:</h3>

			<a href="../productos?opcion=crear" class="btn btn-success btn-lg">
				<span class="glyphicon glyphicon-plus-sign"></span> Ingresar nuevos
				Productos
			</a> 
			<a href="../listadoProductos.jsp" class="btn btn-success btn-lg">
				<span class="glyphicon glyphicon-list-alt"></span> Ver lista de
				Productos
			</a>
	</table>
